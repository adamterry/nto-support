...
// Query `nto_state_budget_sales` table to retrieve data regarding monthly state data for New South Wales
...
if (count($nsw_ms_data) > 0) {
    ...
    echo '<h3>New South Wales</h3><p class="et_pb_text_align_right">Financial year ' . $fy . '</p>';
