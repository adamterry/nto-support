...
// Query `nto_state_budget_sales` table to retrieve data regarding monthly state data for NT
...
if (count($nt_ms_data) > 0) {
    ...
    // Monthly state data found for this state!
    ...
    echo '<h3>Northern Territory</h3><p class="et_pb_text_align_right">Financial year ' . $fy . '</p>';
