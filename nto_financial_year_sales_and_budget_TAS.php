...
// Query `nto_state_budget_sales` table to retrieve data regarding monthly state data for TAS
...
if (count($tas_ms_data) > 0) {
    ...
    echo '<h3>Tasmania</h3><p class="et_pb_text_align_right">Financial year ' . $fy . '</p>';
