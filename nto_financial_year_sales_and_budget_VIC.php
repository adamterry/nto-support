...
// Query `nto_state_budget_sales` table to retrieve data regarding monthly state data for VIC
...
if (count($vic_ms_data) > 0) {
    ...
    echo '<h3>Victoria</h3><p class="et_pb_text_align_right">Financial year ' . $fy . '</p>';
