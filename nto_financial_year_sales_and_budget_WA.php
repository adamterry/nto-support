...
// Query `nto_state_budget_sales` table to retrieve data regarding monthly state data for WA
...
if (count($wa_ms_data) > 0) {
    ...
    echo '<h3>Western Australia</h3><p class="et_pb_text_align_right">Financial year ' . $fy . '</p>';
